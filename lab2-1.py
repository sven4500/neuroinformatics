...
def main():
    ...
    # todo: note that ADALINE uses an identity (linear) activation function
    ...
    # Generate training data. We take consecutive windows of D samples as input and the next
    # sample after the window as the desired output. We train the network to predict the time series.
    # The resulting network has D inputs and 1 output.
    ...
    fig.tight_layout()  # avoid overlapping title and axis labels
